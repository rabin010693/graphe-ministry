...
<header class="hero bg-primary text-white py-5 position-relative overflow-hidden" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?= base_url('assets/img/hero-bg.jpg') ?>') center/cover no-repeat;">
    <div class="container text-center py-5 position-relative">
        <span class="badge bg-danger text-uppercase tracking-wider px-3 py-2 mb-3 fw-semibold"><?= lang('Downloads.sword_of_spirit.badge') ?></span>
        <h1 class="display-5 fw-bold text-white mb-2"><?= lang('Downloads.sword_of_spirit.hero_title') ?></h1>
        <p class="lead text-light opacity-85 mx-auto" style="max-width: 600px;"><?= lang('Downloads.sword_of_spirit.hero_subtitle') ?></p>
    </div>
</header>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="list-group list-group-flush border rounded-3 overflow-hidden shadow-sm">
                    <?php if(!empty($bulletins)): foreach($bulletins as $b): ?>
                        <?php 
                    ...
                    <?php endforeach; else: ?>
                        <div class="p-4 text-center text-muted"><?= lang('Downloads.sword_of_spirit.empty') ?></div>
                    <?php endif; ?>
                </div>
        ...
        <div class="alert alert-warning border-0 bg-opacity-10 text-dark p-4 rounded-4 shadow-sm mb-0">
            <div class="d-flex">
                <i class="fas fa-exclamation-triangle text-warning fs-4 me-3 mt-1"></i>
                <div>
                    <h6 class="fw-bold text-dark mb-2"><?= lang('Downloads.sword_of_spirit.notice_title') ?></h6>
