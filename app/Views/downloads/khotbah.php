...
<header class="hero bg-primary text-white py-5 position-relative overflow-hidden" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?= base_url('assets/img/hero-bg.jpg') ?>') center/cover no-repeat;">
    <div class="container text-center py-5 position-relative">
        <span class="badge bg-danger text-uppercase tracking-wider px-3 py-2 mb-3 fw-semibold"><?= lang('Downloads.sermons.badge') ?></span>
        <h1 class="display-5 fw-bold text-white mb-2"><?= lang('Downloads.sermons.hero_title') ?></h1>
        <p class="lead text-light opacity-85 mx-auto" style="max-width: 600px;"><?= lang('Downloads.sermons.hero_subtitle') ?></p>
    </div>
</header>
    ...
    <div class="container">
        ...
        <div class="alert alert-warning border-0 bg-opacity-10 text-dark p-4 rounded-4 shadow-sm mb-0">
            <div class="d-flex">
                ...
                <div>
                    <h6 class="fw-bold text-dark mb-2"><?= lang('Downloads.sermons.audio_info_title') ?></h6>
