...
<header class="hero" style="padding-top: 80px;">
    <div class="container text-center pt-4 pb-4">
        <div class="eyebrow mb-3"><?= lang('Home.hero.welcome') ?></div>
        <h1 class="mx-auto" style="max-width: 760px;"><?= lang('Home.hero.verse_text') ?></h1>
        <p class="lead mx-auto mt-3"><?= lang('Home.hero.verse_ref') ?></p>
        <a href="<?= base_url('gereja/jadwal_kebaktian') ?>" class="btn-church mt-3"><?= lang('Home.hero.cta_button') ?></a>
    </div>

    <div class="hero-figure text-center my-3" style="max-width: 240px; margin: 0 auto;">
    ...
    <div class="hero-dots text-center pb-2">
