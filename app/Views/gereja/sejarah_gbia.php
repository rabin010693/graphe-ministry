...
<!-- <header class="hero bg-primary text-white py-5 position-relative overflow-hidden" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?= base_url('assets/img/hero-bg.jpg') ?>') center/cover no-repeat;">
    <div class="container text-center py-5 position-relative">
        <span class="badge bg-danger text-uppercase tracking-wider px-3 py-2 mb-3 fw-semibold" data-aos="fade-down"><?= lang('Church.history.badge') ?></span>
        <h1 class="display-5 fw-bold text-white mb-2" data-aos="fade-down" data-aos-delay="100"><?= lang('Church.history.hero_title') ?></h1>
        <p class="lead text-light opacity-85 mx-auto" style="max-width: 600px;" data-aos="fade-down" data-aos-delay="200"><?= lang('Church.history.hero_subtitle') ?></p>
    </div>
</header> -->

<header class="hero pb-5">
    <div class="container text-center pt-5 pb-5">
        <div class="eyebrow mb-3 text-uppercase" data-aos="fade-down" data-aos-duration="800"><?= lang('Church.history.badge') ?></div>
        <h1 class="mx-auto" style="max-width:760px; font-size:2.2rem;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><?= lang('Church.history.hero_title') ?></h1>
        <p class="lead text-light opacity-85 mx-auto" style="max-width: 600px;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"><?= lang('Church.history.hero_subtitle') ?></p>
    </div>
</header>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-12">
                <div class="timeline-container position-relative ps-4 ps-md-5 border-start border-danger border-3 ms-md-4">
                    ...
                    <!-- Timeline Item 4 -->
                    <div class="timeline-item position-relative" data-aos="fade-up">
                        <div class="timeline-dot position-absolute bg-danger rounded-circle shadow" style="width: 20px; height: 20px; left: -31.5px; top: 5px; border: 3px solid #fff;"></div>
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                            <div class="row align-items-center">
                                <div class="col-md-7">
                                    ...
                                    <p class="text-danger fw-bold fst-italic mb-0">Maranatha!</p>
                                </div>
                                <div class="col-md-5 mb-3 mb-md-0">
                                    <div class="rounded-3 overflow-hidden bg-secondary bg-opacity-10 text-center position-relative h-100" style="min-height: 250px;">
        ...
        <!-- Row 3: Nilai / Core Values (Ditambahkan efek delay agar muncul bergantian secara estetik) -->
