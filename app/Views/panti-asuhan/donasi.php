...
<header class="hero bg-primary text-white py-5 position-relative overflow-hidden" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?= base_url('assets/img/hero-bg.jpg') ?>') center/cover no-repeat;">
    <div class="container text-center py-5 position-relative">
        <span class="badge bg-danger text-uppercase tracking-wider px-3 py-2 mb-3 fw-semibold"><?= lang('Orphanage.donation.badge') ?></span>
        <h1 class="display-5 fw-bold text-white mb-2"><?= lang('Orphanage.donation.hero_title') ?></h1>
        <p class="lead text-light opacity-85 mx-auto" style="max-width: 600px;"><?= lang('Orphanage.donation.hero_subtitle') ?></p>
    </div>
</header>
    ...
    <div class="container">
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4 p-md-5">
                ...
                <h5 class="fw-bold text-dark mb-3"><?= lang('Orphanage.donation.ways_title') ?></h5>
                ...
                <div class="alert alert-primary border-0 bg-opacity-10 text-dark p-3 rounded-3 mb-0 small">
        ...
        <!-- Card Kunjungi Kami -->
        <div class="card border-0 shadow-sm rounded-4 bg-dark text-warning overflow-hidden">
            <div class="card-body p-4 p-md-5">
